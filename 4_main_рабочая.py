# файл бота main.py
# этот экземпляр кода поддерживает историю, поддерживаетпередачу 
# сообщений, больше 4096 символов, как от LLM, так и от пользователя
# пишет 'Думаю...', когда получил вопрос от пользователя и направил его к LLM
import os
import asyncio
import logging
import json
...
"""
# выдаëь юольщие сообщения от LLM, разбивая их на маленькие под лимиты телеграм
import os
import asyncio
import logging
import json
